...
namespace DZN4JR_HFT_2022231.Repository.DbContexts
{
    public class PaintStoreMemoryDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Paint(1111, "falfesték", 4560, "5 liter", "fehér", 44444),  
                new Paint(2222, "falfesték", 6250, "6 liter", "zöld", 22222),  
                new Paint(3333, "fafesték", 7590, "2.4 liter", "fekete", 33333),  
                new Paint(4444, "fémfesték", 4160, "1 liter", "fehér", 11111),  
            };

            var geza = new Customer(123, "Szabó Géza", "1125 Budapest Költő u. 7.", "szabogeza@gmail.com", true, 1111);
            var janos = new Customer(345, "Horváth János", "1191 Budapest Rózsa u. 22.", "horvathjanos@gmail.com", false, 2222);
            var zoltan = new Customer(123, "Németh Zoltán", "1162 Budapest Vak Bottyán u. 34.", "nemeth33@gmail.com", true, 3333);
            var ede = new Customer(123, "Teller Ede", "1016 Budapest Galeotti u. 80.", "tellerede@gmail.com", true, 1111);
